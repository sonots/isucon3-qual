...
class Isucon3App < Sinatra::Base
  ...
  get '/mypage' do
    ...
    memos = mysql.xquery('SELECT id, first_sentence, is_private, created_at, updated_at FROM memos WHERE user=? ORDER BY created_at DESC', user["id"])
